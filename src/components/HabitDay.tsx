...
export function HabitDay({date, defaultCompleted = 0, amount = 0, ...props}: HabitDayProps) {
  ...
  return (
    <Popover.Root>
      ...
      <Popover.Portal>
        <Popover.Content className='min-w-[20rem] p-6 rounded-2xl bg-zinc-900 flex flex-col focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 focus:ring-offset-background'>
